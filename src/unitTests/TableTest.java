...
public class TableTest {
  ...
  public void mini_project1() {
        ...
        ImageWriter imageWriter = new ImageWriter("MINI PROJECT 1,2", 200, 200, 800, 800);
        Render render = new Render(imageWriter, scene)
                .setMultithreading(5).setDebugPrint();
    ...
    public void depthOfFieldTest() {
        ...
        ImageWriter imageWriter = new ImageWriter("depthOfFieldTestP0", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene)
                .setMultithreading(5).setDebugPrint();
...
//********************the test of:depth Of Field And Adaptive Super Sampling Test
    @Test
    public void depthOfFieldAndAdaptiveSuperSamplingTest() {
        double radius=3;
        Scene scene = new Scene("Test scene");
        Table table=new Table(90,250,20,3,4.6,3,
                8,new Vector(1,0,0),new Vector(0,-0.1,1),new Point3D(0,20,-400));
        scene.setCamera(new Camera(new Point3D(40, -10, -700), new Vector(0, 0, 1), new Vector(0, -1, 0),1.2,400,true,13));
        scene.setDistance(1000);
        scene.setBackground(new Color(220,225,200));
        scene.setAmbientLight(new AmbientLight(new Color(java.awt.Color.black), 0.08));
        ...
        ImageWriter imageWriter = new ImageWriter("depthOfFieldAndAdaptiveSuperSamplingTest", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene)
                .setMultithreading(5).setDebugPrint();
